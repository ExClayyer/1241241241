document.addEventListener('DOMContentLoaded', function () {
    ...
    var page = currentPage.replace('.html', '');
    var routeMap = { '': 'index', cart: 'catalog', login: 'catalog', register: 'catalog', profile: 'catalog' };
    var activePage = routeMap[page] || page;
    var navLinks = [
    ...
    var navHtml = navLinks.map(function (link) {
        var linkPage = link.href.replace('.html', '');
        var activeAttr = linkPage === activePage ? ' class="active"' : '';
    ...
    var count = (window.veloData && window.veloData.getCartCount) ? window.veloData.getCartCount() : 0;
